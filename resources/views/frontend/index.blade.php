                            ...
                            <div class="col-lg-12 col-lg-9 col-12">
                                <div class="slider-content">
                                    <div class="slider-shape">
                                        <h2 data-swiper-parallax="-500">Amazing Electrocis Shopping</h2>
                                        ...
                                        <a href="{{ url('/product/shop') }}" data-swiper-parallax="-300">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="product-area">
    <div class="fluid-container">
        ...
        @foreach ($products as $product)
            @include('frontend.parts.product_list', ['product', $product, 'moreload'=> "moreload"])
        @endforeach
